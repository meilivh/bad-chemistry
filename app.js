...
function drawWaffleChart(fullWidth, fullHeight, chart) {
    ...
    const numTop = isMobile ? 10 : TOP50.length;
    ...
    const top50SpacingX = numTop > 1 ? (DOT_W - DOT_R_BIG * 2) / (top50Cols - 1) : 0;
    const top50SpacingY = DOT_R_BIG * 2 + 32;
